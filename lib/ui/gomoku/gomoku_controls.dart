...
class GomokuControls extends ConsumerWidget {
  const GomokuControls({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isPlaying = game.status == GomokuGameStatus.playing;
        ...
        child: Row(
          ...
          children: [
            _Btn(Icons.undo, 'Undo',
                ...
                () => ref.read(gomokuGameProvider.notifier).undo()),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(ctx);
              ref.read(gomokuGameProvider.notifier).resign();
            },
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(ctx);
              ref.read(gomokuGameProvider.notifier).newGame();
            },
